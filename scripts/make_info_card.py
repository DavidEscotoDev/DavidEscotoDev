...
# ===========================================================================
HOST = "DavidEscotoDev"   # shown as  DavidEscotoDev@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "AI Agent Infrastructure developer"),
    ("kv", "Prev", "Backend developer"),
    ("kv", "Also", "Machine learning especialist"),
    ("kv", "Edu", "Computer Science / Engineering"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Python, FastAPI, PostgreSQL, Redis"),
    ("kv", "AI / ML", "PyTorch, LangChain, Transformers, ONNX"),
    ("kv", "Infra", "Docker, Kubernetes, AWS, CI/CD"),
    ("kv", "Tools", "Git, Linux, VS Code, Prometheus"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building AI agent infrastructure at scale"),
    ("bul", "ML model deployment & optimization"),
    ("bul", "High-performance backend systems"),
]
